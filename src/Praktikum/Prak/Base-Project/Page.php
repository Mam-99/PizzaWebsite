        ...
        <body>
            ...
            <nav class="navigation">
                <div class="navigation-links">
                    <a class="menu-item" id="link-bestellungseite" href="bestellungseite.php">Bestellung</a>
                    <a class="menu-item" id="link-kunde" href="kunde.php">Kunde</a>
                    <a class="menu-item" id="link-backer" href="baecker.php">Bäcker</a>
                    <a class="menu-item" id="link-fahrer" href="fahrer.php">Lieferung</a>
                </div>
            </nav>
            </div>
        EOT;
